...
const resendOtp = async (userModel, req, res) => {
	...
	if (existingUser) {
		...
		const resultPassword = await UserPassword.findOneAndUpdate({ user: req.body.userId }, UserPasswordData, { new: true, upsert: true });
