...
const createUserController = (userModel) => {
  ...
  userController.updateAdminProfile = (req, res) => updateAdminProfile(userModel, req, res);
  ...
  userController.resendEmailOtp = (req, res) => resendEmailOtp(userModel, req, res);
  userController.completeProfile = (req, res) => completeProfile(userModel, req, res);
  userController.addVerifyImage = (req, res) => addVerifyImage(userModel, req, res);
  userController.profileVerified = (req, res) => profileVerified(userModel, req, res);
  ...
  userController.emailVerified = (req, res) => emailVerified(userModel, req, res);
  userController.sendWaitlistMail = (req, res) => sendWaitlistMail(userModel, req, res);
  userController.dashbaordData = (req, res) => dashbaordData(userModel, req, res);
  userController.adminSidebarData = (req, res) => adminSidebarData(userModel, req, res);
  userController.passwordMatch = (req, res) => passwordMatch(userModel, req, res);
