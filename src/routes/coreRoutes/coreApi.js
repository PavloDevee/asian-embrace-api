...
const { singleStorageUpload, doubleStorageUpload, ProfileImages } = require('@/middlewares/uploadMiddleware');
...
router
  ...
  .patch(adminAuth.isValidAuthToken, catchErrors(adminController.updateAdminProfile));
router.route('/user/delete/:id').delete(catchErrors(adminController.delete));
router.route('/user/read/:id').get(adminAuth.isValidAuthToken, catchErrors(adminController.read));
router.route('/user/match-password/:password').get(adminAuth.isValidAuthToken, catchErrors(adminController.passwordMatch));
router.route('/user/resend-otp').post(catchErrors(adminController.resendOtp));
router.route('/user/resend-otp-email').post(catchErrors(adminController.resendEmailOtp));
router.route('/user/email-verify').post(catchErrors(adminController.emailVerified));
router.route('/user').get(adminAuth.isValidAuthToken, catchErrors(adminController.read));
router.route('/user/listAll').get(adminAuth.isValidAuthToken, catchErrors(adminController.listAll));
router.route('/user/upload-verify-image').patch(adminAuth.isValidAuthToken, singleStorageUpload({ entity: 'verify-image', fieldName: 'file', fileType: 'image' }), catchErrors(adminController.addVerifyImage));


router.route('/user/discover-list').get(adminAuth.isValidAuthToken, catchErrors(webController.discoverList));
router.route('/user/complete-profile').patch(adminAuth.isValidAuthToken, catchErrors(adminController.completeProfile));
router.route('/user').patch(adminAuth.isValidAuthToken, catchErrors(adminController.update));
router.route('/user/profile-verified/:id').get(adminAuth.isValidAuthToken, catchErrors(adminController.profileVerified));
router.route('/user/upload-photo').patch(adminAuth.isValidAuthToken, singleStorageUpload({ entity: 'user-image', fieldName: 'file', fileType: 'image' }), catchErrors(adminController.uploadPhoto));

router.route('/user/upload-images').patch(adminAuth.isValidAuthToken, ProfileImages({ entity: 'user-image', fieldName1: 'images', fieldName2: 'video' }), catchErrors(adminController.uploadImages));
router.route('/user/change-image').patch(adminAuth.isValidAuthToken, catchErrors(adminController.changeImage));
router.route('/user/delete-image').patch(adminAuth.isValidAuthToken, catchErrors(adminController.deleteImage));
...
router.route('/contact-us').patch(adminAuth.isValidAuthToken, catchErrors(contactUsController.update));
...
router.route('/user/favourite').post(adminAuth.isValidAuthToken, catchErrors(favouriteController.create));
router.route('/user/favourite').get(adminAuth.isValidAuthToken, catchErrors(favouriteController.list));

// //_______________________________ Notification management_______________________________

router.route('/user/notification').get(adminAuth.isValidAuthToken, catchErrors(notificationController.list));
router.route('/user/notification-count').get(adminAuth.isValidAuthToken, catchErrors(notificationController.notificationCount));
router.route('/user/notification-read').get(adminAuth.isValidAuthToken, catchErrors(notificationController.readAll));
router.route('/user/notification-read/:id').get(adminAuth.isValidAuthToken, catchErrors(notificationController.readAll));
...
router.route('/user/report').post(adminAuth.isValidAuthToken, catchErrors(reportController.create));
router.route('/user/report').get(adminAuth.isValidAuthToken, catchErrors(reportController.list));
router.route('/user/report').patch(adminAuth.isValidAuthToken, catchErrors(reportController.update));

// //_______________________________ Rose management_______________________________

router.route('/user/rose').post(adminAuth.isValidAuthToken, catchErrors(roseController.create));
...
// );
router.route('/admin/list').get(adminAuth.isValidAuthToken, catchErrors(adminController.list));
router.route('/admin/profile').get(catchErrors(adminController.profile));
router.route('/admin/status/:id').patch(adminAuth.isValidAuthToken, catchErrors(adminController.status));
...
router.route('/page-content').get(adminAuth.isValidAuthToken, catchErrors(pageContentController.list));
...
router.route('/admin/dashboard').get(adminAuth.isValidAuthToken, catchErrors(adminController.dashbaordData));
router.route('/admin/sidebar').get(adminAuth.isValidAuthToken, catchErrors(adminController.adminSidebarData));

// //_______________________________ Image Storage Routes _______________________________

router.post('/storage/upload', upload.single('imageFile'), catchErrors(handleImageUpload));
